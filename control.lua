...
local function handle_placement_built(event)
    ...
    if (surface.name == "nauvis") and (entity.name == "offshore-pump") then 
        entity.active = false
        return 
    end
    if (surface.name ~= "nauvis") and (entity.name == "bit-pump" or entity.name == "byte-pump" or entity.name == "word-pump" or entity.name == "doubleword-pump") then
        entity.active = false
        return 
    end
    ...
    if (surface.name ~= "nauvis") and entity.valid and (entity.name == "simulacrum-computer-1" or entity.name == "simulacrum-computer-2" or entity.name == "simulacrum-computer-3" or entity.name == "simulacrum-computer-4") then
        entity.active = false
    ...
    -- Handling ports
    if entity.valid and entity.name == "simulacrum-port" then
        if (global.computers == nil) then 
            return
        end
    ...
    -- Handling chests
    if entity.valid and entity.name == "quantum-chest" then
        entity.operable = false
        entity.active = false
        if (global.quantum_chests == nil) then 
            global.quantum_chests = {}
        end
        global.quantum_chests[surface.name] = true
        global.quantum_chests[entity.unit_number] = surface.name
